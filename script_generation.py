...
def generate_openai(interests, topic):
    response = openai.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"Based on the user's '{interests}', generation a short paragraph script in a way that user will explain the '{topic}' with analogy of the interests mentioned."}
        ],
        n=1,
        stop=None,
        temperature=0.7,
